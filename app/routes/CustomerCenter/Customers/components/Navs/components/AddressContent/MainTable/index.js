  ...
  return (
    <div className="mt-3">
      <Table responsive striped>
        ...
        <tbody>
          <tr>
            <th className={classes.tbodyFont}>{Demodata.CreditCard.Street1}</th>
            <th className={classes.tbodyFont}>{Demodata.CreditCard.Street2}</th>
            <th className={classes.tbodyFont}>{Demodata.CreditCard.City}</th>
            <th className={classes.tbodyFont}>{Demodata.CreditCard.State}</th>
            <th className={classes.tbodyFont}>{Demodata.CreditCard.PostalCode}</th>
