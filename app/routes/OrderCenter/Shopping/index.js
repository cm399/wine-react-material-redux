...
import iconCart from 'images/commonIcons/cart.svg'
...
import {Row, Col, CardTitle, Input, Button, ButtonGroup, Card, Label} from 'reactstrap'
        ...
        <Col className="p-3 d-flex justify-content-end">
          <span>
            <div className={classes.backgroundColor}>
              <img src={iconCart} className={classes.imageStyle} onClick={routeChange} />
            </div>
          </span>
        </Col>
      </Row>
